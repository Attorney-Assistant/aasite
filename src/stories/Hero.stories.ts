...
export const HeroDefault: Story = {
  ...
  render: () => {
    ...
    container.innerHTML = `
      ...
      <section style="background: linear-gradient(135deg, #15385f, #091623); padding: 80px 0; color: white; position: relative; overflow: hidden;">
        <div style="position:absolute;width:500px;height:500px;border-radius:50%;background:radial-gradient(circle,rgba(81,166,220,0.15) 0%,rgba(81,166,220,0) 65%);top:-30%;right:-5%;animation:sbFloat1 12s ease-in-out infinite;"></div>
        <div style="position:absolute;width:400px;height:400px;border-radius:50%;background:radial-gradient(circle,rgba(249,166,45,0.12) 0%,rgba(249,166,45,0) 65%);bottom:-25%;left:-5%;animation:sbFloat2 15s ease-in-out infinite;"></div>
        <div style="max-width: 1200px; margin: 0 auto; padding: 0 24px; position: relative; z-index: 1;">
          <div style="max-width: 700px;">
            ...
            <button style="background: #f9a62d; color: #0b0000; border: none; padding: 14px 28px; border-radius: 8px; font-family: 'Inter', sans-serif; font-weight: 600; font-size: 16px; cursor: pointer;">
  ...
  render: () => {
    ...
    container.innerHTML = `
      ...
      <section style="background: white; padding: 64px 0; position: relative; overflow: hidden; border-bottom: 1px solid #eaecf0;">
        <div style="position:absolute;width:450px;height:450px;border-radius:50%;background:radial-gradient(circle,rgba(81,166,220,0.18) 0%,rgba(81,166,220,0) 70%);top:-20%;right:-8%;animation:sbFloat3 12s ease-in-out infinite;"></div>
        <div style="position:absolute;width:400px;height:400px;border-radius:50%;background:radial-gradient(circle,rgba(249,166,45,0.15) 0%,rgba(249,166,45,0) 70%);bottom:-20%;left:-8%;animation:sbFloat4 15s ease-in-out infinite;"></div>
        <div style="max-width: 800px; margin: 0 auto; padding: 0 24px; text-align: center; position: relative; z-index: 1;">
          <span style="display: inline-block; background: #f0f7fc; color: #15385f; font-family: 'Inter', sans-serif; font-size: 12px; font-weight: 600; padding: 4px 12px; border-radius: 999px; margin-bottom: 16px;">About Us</span>
...
export const CTABannerGold: Story = {
  ...
  render: () => {
    const container = document.createElement("div");
    container.innerHTML = `
      <section style="background: #f9a62d; padding: 64px 0; color: #0b0000; text-align: center;">
        <div style="max-width: 800px; margin: 0 auto; padding: 0 24px;">
          <h2 style="font-family: 'Sora', sans-serif; font-weight: 700; font-size: 36px; margin: 0 0 16px 0;">
