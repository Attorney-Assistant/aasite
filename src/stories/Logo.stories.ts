...
const logos = [
  ...
  { file: "long_white_logo.svg", label: "Horizontal — White", bg: "#15385f", text: "white" },
  ...
  { file: "tall_white_logo.svg", label: "Vertical — White", bg: "#15385f", text: "white" },
...
const iconVariants = [
  ...
  { file: "white_icon.svg", label: "Icon — White SVG", bg: "#15385f", text: "white" },
  { file: "white_icon.png", label: "Icon — White PNG", bg: "#15385f", text: "white" },
];
  ...
  return `
    <div style="border: 1px solid #eaecf0; border-radius: 12px; overflow: hidden;">
      ...
      <div style="padding: 10px 16px; display: flex; align-items: center; justify-content: space-between; border-top: 1px solid #eaecf0; background: #fafafa;">
        ...
        <a href="/brand/logos/${logo.file}" download style="font-family: 'Inter', sans-serif; font-size: 11px; font-weight: 600; color: #15385f; text-decoration: none; padding: 4px 10px; border: 1px solid #d0d5dd; border-radius: 6px;">Download</a>
      </div>
    </div>
  `;
}
...
export const AllLogos: Story = {
  render: () => {
    ...
    container.innerHTML = `
      ...
      <h3 style="font-family: 'Sora', sans-serif; font-size: 16px; font-weight: 700; margin-bottom: 16px; color: #15385f;">Full Logos</h3>
      <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 16px; margin-bottom: 40px;">
        ${logos.map(l => logoCard(l)).join("")}
      </div>

      <h3 style="font-family: 'Sora', sans-serif; font-size: 16px; font-weight: 700; margin-bottom: 16px; color: #15385f;">Icon / Favicon Variants</h3>
